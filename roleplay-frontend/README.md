...
🚀 [Finish setting up your workspace](https://cloud.nx.app/connect/tdgecQYKOv) to get faster builds with remote caching, distributed task execution, and self-healing CI. [Learn more about Nx Cloud](https://nx.dev/ci/intro/why-nx-cloud).
## 📦 Project Overview
